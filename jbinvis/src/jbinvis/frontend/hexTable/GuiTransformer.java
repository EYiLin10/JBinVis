...
//		Double[][] trigram = CommonUtils.getTrigram(SphereSettingsPanel.bytesRead);
//		Double[][] cartesian = CommonUtils.getCartesian(CommonUtils.getPolar(trigram));
		
//		SphereSettingsPanel.sphereCoords = cartesian;
