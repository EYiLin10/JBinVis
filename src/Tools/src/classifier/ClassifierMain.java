 ...
 * @author Billy
 */
public class ClassifierMain implements DirectoryWorker.DirectoryWorkerHandler{
        ...
        while(!directories.isEmpty()) {
            ...
            if(!dispatched) {
                ...
                try {
                    ...
                    Logger.getLogger(ClassifierMain.class.getName()).log(Level.SEVERE, null, ex);
                }
                retryTimeout <<=1;
